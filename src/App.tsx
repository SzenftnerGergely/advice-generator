...
function App() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      <div className="max-w-[540px] flex flex-col items-center relative bg-[#313a49] p-10 rounded-lg">
        <p className="text-[#3fdd8e] font-semibold text-lg uppercase tracking-[0.3rem]">Advice #{advice.id}</p>
        <p className="text-[#cee3e9] text-3xl text-center my-6 font-semibold leading-10">"{advice.advice}"</p>
